...
collection = db.first_collection_test



image_dir = "/home/c-use/Desktop/main_directory/d_1/w_2/1"

list_gpx = xml_to_list(image_dir)


for each, i,j in zip(sorted(glob.glob(image_dir + '/*.jpg')),range(len(list_gpx)),range(52)):
  comb(list_gpx[i],each)
